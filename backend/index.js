...
const inscriptionRoutes = require('./routes/inscription'); // Ajout de la route d'inscription
...
app.use('/inscription', inscriptionRoutes); // Ajout de la route d'inscription
