<template>
   <div class="page-container">
         ...
         <div class="firstSec2Container">
           <div class="calendrierContainer">
             ...
             <div class="datesEvent">
               <p class="ligneDate"><span class="span3">17</span><span class="verticalDate">Juillet <br /><span class="journeeCalendrier">Première journée</span></span></p>
               <p class="ligneDate"><span class="span3">18</span><span class="verticalDate">Juillet <br /><span class="journeeCalendrier">Deuxième journée</span></span></p>
               <p class="ligneDate"><span class="span3">19</span><span class="verticalDate">Juillet <br /><span class="journeeCalendrier">Troisième journée</span></span></p>
             </div>
           </div>
         </div>
     ...
     <div class="section" id="section2B">
       ...
       <router-link to="/articleguide" tag="div" class="carteGuidePratique">
         ...
         <p class="sousTitreHistoireCircuitUn">📰 - Article <span class="sousTitreLectureEnUn">(Lecture en 5 min)</span></p>
       </router-link>
     </div>
 ...
 >
   ...
   <g id="g1" style="display:inline">
     <image width="2341" height="1317" preserveAspectRatio="true" :xlink:href="currentImagePrincipal" />
   </g>
 
   <!-- Couche Stands -->
   <g id="coucheStands" ref="coucheStands" :style="{ opacity: withStands ? 1 : 0, transition: withTransition ? 'opacity 0.25s' : 'opacity 0s' }">
     <image width="2341" height="1317" preserveAspectRatio="true" :xlink:href="carteCoucheStands" />
   </g>
 
   <!-- Couche Kiosque Info -->
   <g id="coucheKiosqueInfo" ref="coucheKiosqueInfo" :style="{ opacity: withKiosqueInfo ? 1 : 0, transition: withTransition ? 'opacity 0.25s' : 'opacity 0s' }">
     <image width="2341" height="1317" preserveAspectRatio="true" :xlink:href="carteCoucheKiosqueInfo" />
   </g>
 
   <!-- Couche DAB -->
   <g id="coucheDAB" ref="coucheDAB" :style="{ opacity: withDAB ? 1 : 0, transition: withTransition ? 'opacity 0.25s' : 'opacity 0s' }">
     <image width="2341" height="1317" preserveAspectRatio="true" :xlink:href="carteCoucheDAB" />
   </g>
 
   <!-- Couche Poste de secours -->
   <g id="couchePosteSecours" ref="couchePosteSecours" :style="{ opacity: withPosteSecours ? 1 : 0, transition: withTransition ? 'opacity 0.25s' : 'opacity 0s' }">
     <image width="2341" height="1317" preserveAspectRatio="true" :xlink:href="carteCouchePosteSecours" />
   </g>
 
   <!-- Couche Toilettes -->
   <g id="coucheToilettes" ref="coucheToilettes" :style="{ opacity: withToilettes ? 1 : 0, transition: withTransition ? 'opacity 0.25s' : 'opacity 0s' }">
     <image width="2341" height="1317" preserveAspectRatio="true" :xlink:href="carteCoucheToilettes" />
   </g>
 
   <!-- Couche PitStop -->
   <g id="couchePitStop" ref="couchePitStop" :style="{ opacity: withPitStop ? 1 : 0, transition: withTransition ? 'opacity 0.25s' : 'opacity 0s' }" @mouseover="showToolTipCircuit()">
     <image width="2341" height="1317" preserveAspectRatio="true" :xlink:href="carteCouchePitStop" />
   </g>
   ...
   <g v-if="withEmplacementPrincipaux">
     ...
     >
       <path :class="['base-path', { highlight: emplacement.highlight }]" :d="emplacement.path" />
     </g>
   </g>
     ...
     >
       <path
         :style="styleStandsActive
           ? {
               display: 'inline',
               fill: emplacement.statut === 'RÉSERVÉ'
                 ? 'red'
                 : (emplacement.statut === 'LIBRE' ? 'green' : 'transparent'),
               opacity: (emplacement.statut === 'RÉSERVÉ' || emplacement.statut === 'LIBRE') ? 0.3 : 0,
               cursor: 'pointer',
   ...
   <g id="overlay" style="opacity: 0; transition: opacity 0.25s; pointer-events: none;">
     <image width="2341" height="1317" preserveAspectRatio="true" :xlink:href="overlayImage" />
   </g>
 </svg>
         <!-- TOOLTIP STANDARD -->
